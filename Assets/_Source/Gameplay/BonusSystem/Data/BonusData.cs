...
namespace _Source.Gameplay.BonusSystem.Data
{
    public abstract class BonusData : ScriptableObject
    {
        ...
        public void IncreaseGoldPrice() => _currentGoldPrice += _amountDollarPrice;
        
        public void IncreaseDollarPrice() => _currentDollarPrice += _amountGoldPrice;
        
        public void SetPrice(int newPrice) => _currentGoldPrice = newPrice;
        
        public void ResetToGameplayPrice() => _currentDollarPrice = _baseDollarPrice;
    }
}